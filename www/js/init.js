(() => {
  ...
  const classes = [
    ...
    ['Vue', 'VueJeu', 'VueAtelier', 'VueRunner', 'VueLecons', 'VueQuestion', 'VueReponse', 'VueUnivers', 'VueRegle', 'VueLecon', 'VueStats', 'VueMenuPrincipal', 'VueOptions', 'VuePause', 'VuePerdu', 'VueShooter', 'VueVictoire', 'VueBoutique', 'VueConfirmationReinit', 'VueCredits']
  ];
