(() => {
  ...
  const classes = [
    ...
    ['Vue', 'VueJeu', 'VueAtelier', 'VueRunner', 'VueLecons', 'VueStats', 'VueLeconsStats', 'VueMenuPrincipal', 'VueOptions', 'VuePause', 'VuePerdu', 'VueShooterBoss', 'VueShooterEchec', 'VueVictoire', 'VueBoutique']
  ];
