class VuePerdu extends Vue {
  constructor(ctrl) {
    ...
    this.hscore = this.create('p');
    this.add(divB,this.hscore);
    this.hscore.innerHTML = "Votre meilleur score est de "+this.controleur.getUtilisateur().getHighScore()+" points";
